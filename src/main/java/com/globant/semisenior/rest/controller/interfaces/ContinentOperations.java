...
public interface ContinentOperations {
  ...
  @ApiOperation(
      value = "Controller that get a continent by Id",
  ...
  //update -> que ya exista continente -> merge entre los countries existentes y nuevos
  @ApiOperation(
      value = "Controller that update a continent",
      notes = "Given a continent with countries and these with cities",
      response = SetupResponseDTO.class
  )
  @ApiResponses(value = {
  ...
  ResponseEntity<ContinentDTO> updateContinent(
      @RequestBody final ContinentDTO continent);
